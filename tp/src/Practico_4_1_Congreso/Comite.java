...
public class Comite {
	...
	//obtener lista de evaluadores que pueden evaluar un trabajo
	
	public ArrayList AsignarEvaluadoresA(Trabajo t) {
		ArrayList EvaluadoresCalificados= new ArrayList();
		for (EvaluadorB e:evaluadores) {
			if( e.Apto_trabajo(t)){
				EvaluadoresCalificados.add(e);
				
			}
		}
		return EvaluadoresCalificados;
	}
